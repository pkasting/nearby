...
bool BleMedium::StartAdvertising(
  ...
  switch (publisher_state_future.get()) {
    case PublisherState::kStarted:
      return true;
    case PublisherState::kError:
    default:
      return false;
  }
  return false;
...
bool BleMedium::StartScanning(
  ...
  while (!is_watcher_started_) {
    ...
    switch (watcher_state_future.get()) {
      case WatcherState::kStarted:
        return true;
      case WatcherState::kError:
      default:
        return false;
    }
  }
